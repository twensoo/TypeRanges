...
int main(int, char *[]) {
	...
	// short
	std::cout << std::endl
	std::cout << std::setw(text_width) << "short";
	...
	// unsigned short
	std::cout << std::endl
	std::cout << std::setw(text_width) << "unsigned short";
	...
	// int
	std::cout << std::endl
	std::cout	<< std::setw(text_width) << "int";
  ...
  std::cout << std::setw(text_width) << "unsigned int";
	...
	// long
	std::cout << std::endl
	std::cout << std::setw(text_width) << "long";
	...
	// unsigned long
	std::cout << std::endl
	std::cout << std::setw(text_width) << "unsigned long";
	...
	// long long
	std::cout << std::endl
	std::cout << std::setw(text_width) << "long long";
	...
	// unsigned long long
	std::cout << std::endl
	std::cout << std::setw(text_width) << "unsigned long long";
	...
	// unsigned size_t
	std::cout << std::endl
	std::cout << std::setw(text_width) << "std::size_t";
